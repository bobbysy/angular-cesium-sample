...
/**
 *  Taken from https://github.com/angular/angular/blob/master/aio/src/app/shared/custom-icon-registry.ts
 */
...
export class CustomIconRegistry extends MatIconRegistry {
  ...
  private loadSvgElements(svgIcons: SvgIconInfo[]): void {
    const div = document.createElement("DIV");
    svgIcons.forEach((icon) => {
      const ns = icon.namespace || DEFAULT_NS;
      const nsIconMap =
        this.preloadedSvgElements[ns] || (this.preloadedSvgElements[ns] = {});
